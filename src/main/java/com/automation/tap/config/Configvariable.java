package com.automation.tap.config;

import com.automation.tap.constants.Constants;
...
public class Configvariable {
    ...
    public void setupEnvironmentProperties(String envName, String lbu) {
        ...
        if (!lbu.isEmpty()) {
            ...
            initialStream = getClass().getResourceAsStream("/env/"+ envName.toLowerCase() + ".properties");
        }
    ...
    public boolean isCookieRequired(){
        if (System.getProperty(Constants.COOKIE_KEYS) == null) {
            return !getStringVar(Constants.COOKIE_KEYS).isEmpty();
        } else {
            setStringVariable(System.getProperty(Constants.COOKIE_KEYS),Constants.COOKIE_KEYS);
            setStringVariable(System.getProperty(Constants.COOKIE_VALUES),Constants.COOKIE_VALUES);
            return true;
        }
    }
