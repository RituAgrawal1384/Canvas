package com.automation.platform.appium;
...
public class AppiumCommands {
    private static final Logger LOGGER = LoggerFactory.getLogger(AppiumCommands.class);
...
//            WebDriverWait wait = new WebDriverWait(driver, timeOut);
    ...
    public void getNetworkConnection() {
        LOGGER.info("Network setting is ",((AndroidDriver) driver).getConnection());
    }
...
//    }
    ...
    public void handlePhotoPermission(String option, String bundleID) {
        if (isAlertPresent()) {
            acceptAlert();
