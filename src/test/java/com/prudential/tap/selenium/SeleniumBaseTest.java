//package com.prudential.tap.selenium;
//
...
//        configvariable.setStringVariable("uat-sales.eb.prudential.com.sg", "bluegreen.cookie.domain");
//
//        seleniumBase.launchApplication("https://uat-sales.eb.prudential.com.sg/login", "", "");
//        if (configvariable.isCookieRequired()) {
////            seleniumBase.setBrowserCookie();
//            seleniumBase.addDriverCookie("blue;green","false;true","uat-sales.eb.prudential.com.sg");
//        }
//
...
////                        "}]));                                                             " );
//
////        SeleniumBase.driver.get("https://uat-sales.eb.prudential.com.sg/login");
